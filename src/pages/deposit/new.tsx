    ...
    return (
      <CenterBody>
        <Stack minWidth={"400px"} spacing={8}>
          ...
          <Text fontSize={"sm"} textColor={"gray.300"}>
            Please wait. It might takes up to 20 seconds...
          </Text>
        </Stack>
      </CenterBody>
    );
      ...
      <Stack minWidth={"400px"} spacing={8}>
        ...
        <Stack spacing={2}>
          ...
          <Input
            ...
            onChange={(e) => setAllowanceAmount(parseInt(e.target.value))}
          />
        </Stack>
        ...
        <Stack spacing={2}>
          ...
          >
            {!activeAccount ? "Connect wallet" : "Increase Allowance"}
          </Button>
